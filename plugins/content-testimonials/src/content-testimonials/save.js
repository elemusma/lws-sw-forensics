						...
						{ attributes.columns.map( ( column, index ) => {
							return (
								...
								>
									...
									>
										<img src="/wp-content/uploads/2025/11/Google-Icon.png" alt="Google Icon" class="position-absolute" style="top:10px;right:10px;width:30px;height:30px;" />
										...
										<div>
										<h3 className={`h6 bold`} style={{margin:'0px'}}>
											<RichText.Content
												value={ column.title }
											/>
										</h3>
										<div style={{color:"#fcb040"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</div>
										</div>
										</div>
